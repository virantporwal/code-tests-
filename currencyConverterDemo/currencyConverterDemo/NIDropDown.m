...
//- (id)showDropDown:(UIButton *)button:(CGFloat *)height:(NSArray *)arr:(NSArray *)imgArr:(NSString *)direction
-(id)showdropDown:(UIButton*)button height:(CGFloat *)height array:(NSArray *)arrayValue imagArray:(NSArray *)imgArray directioin:(NSString *)direction
{
    btnSender = button;
    ...
    if (self) {
        ...
        self.list = [NSArray arrayWithArray:arrayValue];
